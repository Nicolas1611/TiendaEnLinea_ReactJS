                ...
                <div className="input-group" >
                  <div className="file-field input-field">
                    ...
                    <div className="file-path-wrapper">
                      <input type="number" value={this.state.inputValue} disabled={ (this.props.disponible <= 0 ) ? true : false } min="0" max={this.props.disponible} className="form-control" onChange={evt => this.updateInputValue(evt)}></input>
                    </div>
                  </div>
                </div>
              </div>
